#!/bin/sh
#usage PcGs_finder.sh output_dir iteration# query.fasta KOGID pfm_database
#sequences headers doesn't contains '-', '#' symbol
mkdir $1
...
do
   ...
   emapper.py --annotate_hits_table $1/$fbname.emapper.seed_orthologs --data_dir /media/sharaf/DataBank/ --no_file_comments  -o $1/$fbname --cpu 10
